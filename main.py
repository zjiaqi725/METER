...
parser.add_argument('--beta_e', type=float, help="trade-off param for loss", default=1) 
...
parser.add_argument("--hlr", type=float, help="learning rate of hypernet", default=1e-2)
#IEC
parser.add_argument("--thres_rate", type=float, help="fake label", default=0.05)
parser.add_argument("--uncertainty_threshold", type=float, help="threshold of uncertainty", default=0.1)
parser.add_argument("--uncertainty_avg_threshold", type=float, help="threshold of uncertainty", default=0.1)
